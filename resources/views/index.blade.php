...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
    <section class="menu cid-qP54ZFFg5f" once="menu" id="menu1-j">
        ...
        <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
            ...
            <div class="menu-logo">
                ...
                <span class="navbar-logo">
                    <a href="https://domainreminder.net">
                         <img src="/img/icon-60x60.png" alt="domainrem" title="" style="height: 3.8rem;">
                    </a>
                </span>
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="https://domainreminder.net/">DomainReminder</a></span>
                </div>
            </div>
    ...
    <section class="features8 cid-qP586FcY0k" id="features8-o">
            ...
            <div class="media-container-row">
                ...
                <div class="card  col-12 col-md-6 col-lg-4">
                    ...
                    <div class="card-box align-center">
                        ...
                        <div class="mbr-section-btn text-center"><a href="https://domainreminder.net/" class="btn btn-secondary display-4">
                                More
                            </a></div>
                    </div>
                </div>
