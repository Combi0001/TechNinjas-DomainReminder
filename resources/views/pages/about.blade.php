...
@section('content')
    ...
    <div class="container dark-text" style="padding: 30px;">
            ...
            <p>With our site a user will be able to add a series of domains to a list that our site will check on and
                ...
                changes in its status without having to constantly check themselves.
                Looking forward our team is intending to build a system that will allow users to set an amount they
                would like to bid for a domain, so that if a domain comes up for auction we can then submit a bid up to
                their max amount on their behalf. This feature will include a manual and automatic mode.
            </p></div>
            <div style="max-width:80%;margin-left:10%;padding:10px;"><h4 style="text-align:center;">Who will benefit from it?</h4>
            <p>
                Anyone that is wanting to gather extra information on a domain, such as people;
...
always loves learning new things and putting the learned skills to use!
</p><p>
...
has 3 years of hands-on experience, working with PC, Mac, Server and Print
environments. Once an avid Over-clocking enthusiast, he loves all things
hardware related.
</p><p>
Peter's Strength lies in his versatility and adaptability. His current
...
eager to finish the degree and become proficient in at least one useful area of
IT.
</p><p>
...
After doing a Diploma in IT a few years ago, He has now decided to upgrade it
to a Degree and further pursue his passion.
</p><p>
Not knowing how doesn’t stop him from doing all that he can do
get the job done. To further prove that he is known for saying “There is
...
programming at age 10, making small games with Game Maker, and mods for
Minecraft a few years later. He has since versed himself in many areas of
software development, from O.S. (Operating System) development to Game
Engine development. In recent months Adam has been employed as a Full
Stack Developer for a cloud-based web service development company.
</p><p>
Adam keen interests involve learning new things about
...
people. He also loves the feeling when some challenging code works as
intended, and you get a smug feeling, almost like you’ve managed to impress
yourself.
</p><p>
Alex has strong on HTML/CSS, Trello, Slack skills; Intermediate
on SQL, Adobe Suite & Wordpress; Got the basics of Python, jQuery,
javascript, C#.
</p></div>
        </div>
